  ...
  <div class="indicador-form-wrapper">
    ...
    <form @submit.prevent="submitForm" class="indicador-form">
      ...
      <div class="form-group">
        ...
        <select id="usuario_id" v-model="indicador.usuario_id" required>
      ...
      <div class="form-footer">
        <button type="submit" class="btn-guardar">Guardar Indicador</button>
      </div>
    </form>
  </div>
</template>
...
/* Campo completo cuando sea necesario */
.form-full {
  grid-column: 1 / -1;
}
