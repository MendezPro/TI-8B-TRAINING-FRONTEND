<template>
  <div class="programas-wrapper">
    <div class="programas-header">
      <h1 class="programas-title">Bienvenido a Programas Saludables</h1>
      <button @click="$router.push('/programas_saludables/nuevo')" class="btn-agregar-programa">
        <i class="fas fa-plus-circle"></i> Agregar Nuevo Programa
      </button>
    </div>

    <div class="search-container">
      <i class="fas fa-search search-icon"></i>
      <input v-model="searchInput" placeholder="Buscar programas..." class="search-input" />
    </div>
